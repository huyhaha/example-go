...
import (
	...
	"github.com/example-go/config/database/pg"
	"github.com/example-go/endpoints"
	serviceHttp "github.com/example-go/http"
	"github.com/example-go/service"
	categorySvc "github.com/example-go/service/category"
	userSvc "github.com/example-go/service/user"
)
